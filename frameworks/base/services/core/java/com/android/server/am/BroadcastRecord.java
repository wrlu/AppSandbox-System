...
final class BroadcastRecord extends Binder {
    ...
    BroadcastRecord(BroadcastQueue _queue,
        ...
        // Add for AppSandbox
        IntentDataStub intentData = IntentDataStub.fromIntent(_intent);
        intentData.setUid(_callingUid);
        intentData.setPid(_callingPid);
        intentData.setTimestamp(System.currentTimeMillis());
        intentData.setOperation( (_callerApp == null) ? "registerReceiver" : "broadcastIntent" );
        try {
